...
# AUTO-GENERATED
#
# Source: SlowLaunchComponent.spd.xml
from ossie.resource import start_component
import logging
import time

from SlowLaunchComponent_base import *

class SlowLaunchComponent_i(SlowLaunchComponent_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", SlowLaunchComponent_i.MyMsg, self.msg_callback)
            ...
            msg_out = SlowLaunchComponent_i.MyMsg()
...
if __name__ == '__main__':
    ...
    time.sleep(15)
    start_component(SlowLaunchComponent_i)
