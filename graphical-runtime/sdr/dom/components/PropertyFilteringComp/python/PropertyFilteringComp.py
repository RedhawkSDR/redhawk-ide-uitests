...
from PropertyFilteringComp_base import *

class PropertyFilteringComp_i(PropertyFilteringComp_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", PropertyFilteringComp_i.MyMsg, self.msg_callback)
            ...
            msg_out = PropertyFilteringComp_i.MyMsg()
