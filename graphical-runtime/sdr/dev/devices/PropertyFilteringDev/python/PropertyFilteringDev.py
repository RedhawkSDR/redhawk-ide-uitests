...
from PropertyFilteringDev_base import *

class PropertyFilteringDev_i(PropertyFilteringDev_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", PropertyFilteringDev_i.MyMsg, self.msg_callback)
            ...
            msg_out = PropertyFilteringDev_i.MyMsg()
