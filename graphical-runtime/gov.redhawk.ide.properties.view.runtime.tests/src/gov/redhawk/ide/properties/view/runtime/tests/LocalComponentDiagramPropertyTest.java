...
import gov.redhawk.ide.graphiti.sad.ui.runtime.chalkboard.tests.AbstractGraphitiChalkboardTest;
...
public class LocalComponentDiagramPropertyTest extends LocalComponentPropertyTest {
	...
	protected void prepareObject() {
		RHBotGefEditor editor = AbstractGraphitiChalkboardTest.openChalkboardDiagram(gefBot);
