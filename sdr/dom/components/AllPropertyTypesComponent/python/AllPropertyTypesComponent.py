...
from AllPropertyTypesComponent_base import *

class AllPropertyTypesComponent_i(AllPropertyTypesComponent_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", AllPropertyTypesComponent_i.MyMsg, self.msg_callback)
            ...
            msg_out = AllPropertyTypesComponent_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(AllPropertyTypesComponent_i)
