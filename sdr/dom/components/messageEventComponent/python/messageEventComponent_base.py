...
class messageEventComponent_base(CF__POA.Resource, Component, ThreadedComponent):
        ...
        def __init__(self, identifier, execparams):
            ...
            self.port_messageOut = MessageSupplierPort()
        ...
        port_messageOut = usesport(name="messageOut",
