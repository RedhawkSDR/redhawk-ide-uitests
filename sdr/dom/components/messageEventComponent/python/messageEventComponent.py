...
# AUTO-GENERATED
#
# Source: messageEventComponent.spd.xml
from ossie.resource import start_component
import logging

from messageEventComponent_base import *

class messageEventComponent_i(messageEventComponent_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", messageEventComponent_i.MyMsg, self.msg_callback)
            ...
            msg_out = messageEventComponent_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(messageEventComponent_i)
