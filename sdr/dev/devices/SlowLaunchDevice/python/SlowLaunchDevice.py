...
# AUTO-GENERATED
#
# Source: SlowLaunchDevice.spd.xml
from ossie.device import start_device
import logging

from SlowLaunchDevice_base import *
import time

class SlowLaunchDevice_i(SlowLaunchDevice_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", SlowLaunchDevice_i.MyMsg, self.msg_callback)
            ...
            msg_out = SlowLaunchDevice_i.MyMsg()
