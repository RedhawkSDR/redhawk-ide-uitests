...
# AUTO-GENERATED
#
# Source: AggregateDevice.spd.xml
from ossie.device import start_device
import logging

from AggregateDevice_base import *

class AggregateDevice_i(AggregateDevice_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", AggregateDevice_i.MyMsg, self.msg_callback)
            ...
            msg_out = AggregateDevice_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_device(AggregateDevice_i)
