...
from AllPropertyTypesDevice_base import *

class AllPropertyTypesDevice_i(AllPropertyTypesDevice_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", AllPropertyTypesDevice_i.MyMsg, self.msg_callback)
            ...
            msg_out = AllPropertyTypesDevice_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_device(AllPropertyTypesDevice_i)
