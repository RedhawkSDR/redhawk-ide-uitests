...
from AllPortTypesTestComponent_base import *

class AllPortTypesTestComponent_i(AllPortTypesTestComponent_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", AllPortTypesTestComponent_i.MyMsg, self.msg_callback)
            ...
            msg_out = AllPortTypesTestComponent_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(AllPortTypesTestComponent_i)
