...
public class HotKeysTest extends HotKeysAbstractTest {
	...
	protected void importProjectAndOpen() throws CoreException {
		StandardTestActions.importProject(FrameworkUtil.getBundle(HotKeysTest.class), new Path("workspace/CppComTest"), null);
		ProjectExplorerUtils.openProjectInEditor(bot, "CppComTest", "CppComTest.spd.xml");
		editor = bot.editorByTitle("CppComTest");
		editor.bot().cTabItem("CppComTest.spd.xml").activate();
	}
}
